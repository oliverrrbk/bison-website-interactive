...
const AnoAI = () => {
    ...
    useEffect(() => {
        ...
        renderer.domElement.style.mixBlendMode = 'screen'; // Use screen or lighten so it blends with the sky
      ...
      `,
        ...
        void main() {
          ...
          // Using black background so that it acts nicely with mix-blend-mode: screen
